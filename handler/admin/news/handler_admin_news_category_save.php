...
class handler_admin_news_category_save extends handler_action
{
    ...
    public function run()
    {
        ...
        {
            $page = new layout_admin_news_category_form( $category );
            $page->render();
        }
        else
        {
            ...
            {
                model_news_category::create( $category );
            }
            else
            {
                model_news_category::update( $category );
            }
