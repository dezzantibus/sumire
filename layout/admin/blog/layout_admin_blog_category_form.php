...
class layout_admin_blog_category_form extends layout_admin_page
{

    public function __construct( data_blog_category $category )
    {
        ...
        {
            $message = 'Blog - New category';
        }
        else
        {
            $message= 'Blog - Edit category ' . $category->category;
        }
