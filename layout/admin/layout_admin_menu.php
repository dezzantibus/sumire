            ...
            '<div class="sidebar-collapse">',
                '<ul class="nav metismenu" id="side-menu">',
                    ...
                    else
                    {
                        ...
                        echo
                        '<a href="/news"><i class="fa fa-edit"></i> <span class="nav-label">Blog</span></a>',
                    '</li>';
                    ...
                    else
                    {
                        ...
                        echo
                        '<a href="/news"><i class="fa fa-shopping-cart"></i> <span class="nav-label">Market</span></a>',
                    '</li>';
                    ...
                    else
                    {
                        ...
                        echo
                        '<a href="/news"><i class="fa fa-table"></i> <span class="nav-label">Events</span></a>',
                    '</li>';
