...
class model_recipe_category extends model
{

    static public function create( data_recipe_category $data )
    {
    ...
    static public function update( data_recipe_category $data )
    {
    ...
    static public function delete( $id )
    {
        ...
        $sql = 'DELETE FROM recipe_category WHERE id = :id';
    ...
    static public function getById( $id )
    {
        ...
        $sql = 'SELECT * FROM recipe_category WHERE id = :id';
        ...
        return new data_recipe_category( $row );
    ...
    static public function getFullList( $order='order' )
    {
        ...
        if( empty( $result ) )
        {
            ...
            $sql = "SELECT * FROM recipe_category ORDER BY `$order` ASC";
            ...
            while( $row = $query->fetch() )
            {
                ...
                {
                    $result->add( new data_recipe_category( $row ) );
                }
            }
    ...
    static public function getHomepageList()
    {
        ...
        if( empty( $result ) )
        {
            ...
            $sql = 'SELECT * FROM recipe_category WHERE homepage > 0 ORDER BY `homepage` ASC';
